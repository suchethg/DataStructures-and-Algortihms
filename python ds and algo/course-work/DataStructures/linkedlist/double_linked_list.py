...
# my_double_linked_list.set_value(1,23)
#my_double_linked_list.insert(1,4)
print(my_double_linked_list.remove(1),'\n') 
my_double_linked_list.print_list()
# print(my_double_linked_list.get(1))
# print(my_double_linked_list.get(2))

# print(my_double_linked_list.pop_first())
# print(my_double_linked_list.pop_first())
# print(my_double_linked_list.pop_first())
# my_double_linked_list.prepend(3)
# print(my_double_linked_list.pop())
# my_double_linked_list.print_list()